...
- `personal-chief-of-staff` can now include relationship check-ins and timely
  ...
  is available.
- `personal-chief-of-staff` now records three to five concrete next-day
  commitments with finish lines and user-approved rationales during wind-down,
  reaffirms them in morning without creating another task or calendar system,
  and uses repeated rationale patterns for selective non-scoring coaching.
