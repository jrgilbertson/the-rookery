...
- [route-work](skills/route-work/SKILL.md). Select the first workflow owner, starting topology, and model profile for one work kickoff without starting a downstream workflow. Use it when starting new work or deciding whether a proven in-flight owner should continue.
