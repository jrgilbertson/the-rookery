...
- [checking-simplicity](skills/checking-simplicity/SKILL.md). Challenge a draft software plan or proposed implementation approach before avoidable machinery hardens into code. Use it at the plan-to-build boundary or before an in-build design choice to find the smallest safe approach.
