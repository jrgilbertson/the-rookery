...
- [repo-gardener](skills/repo-gardener/SKILL.md). Check a repository across five maintenance areas and, when warranted, assign parallel workers that each leave one unmerged pull request. Run it on a schedule or by hand; a human still merges.
