...
- [repo-gardener](skills/repo-gardener/SKILL.md). Initialize and reconcile one repository through read-only maintenance scouts. It keeps a seven-slot report-backed portfolio current, and its only possible write is a separately proven report-register operation; source work stays unchanged.
