...
- [repo-gardener](skills/repo-gardener/SKILL.md). Sense one repository, dispatch Executors that each ship one reviewable pull request through the installed shipping and readiness skills, and post one morning report. Run it on a schedule by name; a human still merges.
...
- [humanize](https://github.com/harshaneel/humanize) by Harshaneel Gokhale. Its `ai-check` skill flags AI-sounding writing.
