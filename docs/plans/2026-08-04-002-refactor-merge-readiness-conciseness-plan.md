...
- R7. The readout keeps the colleague’s plain-language register in **natural prose**: continuous sentences and short paragraphs, not form labels. No report-template scaffolding (no section headers such as Themes / Intent / Risk / Drivers), no second visible verdict, no steelman against merging.
