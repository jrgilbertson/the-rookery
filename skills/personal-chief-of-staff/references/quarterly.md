...
Use this mode to turn the available quarter into an executive strategy review
and a small set of deliberate next-quarter commitments. Scheduled and manual
invocations follow the same interactive workflow.
...
State the quarter's main conclusion before presenting detail. Explain the few
outcomes, changes, constraints, and decisions that most affect the user's
direction. Group supporting evidence under those claims and progressively
disclose it instead of listing every source or event.

The synthesis should clarify, where evidence supports it:

- what changed and why it matters;
- which strategy, objective, or assumption gained or lost support;
- which decision is paying off, should be revisited, or remains unmade;
- which execution, relationship, health, or writing pattern could compound;
- what should stop or receive less attention; and
- which few outcomes could create the most sustainable value next quarter.
...
after-action discussion within the review rather than creating another system.
