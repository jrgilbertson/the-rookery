...
State the answer before the inventory. Synthesize the few changes, outcomes,
risks, and decisions that best explain the week and shape the next one. Group
the supporting reasons coherently and reveal detail only where it helps the
user judge the conclusion.

The synthesis should answer, when evidence supports it:
...
the review. Do not add another review cadence or mandatory ceremony.
...
patterns, tradeoffs, blind spots, experiments, and ranked outcomes. The agent
