...
> `b2b31d2b52e1aa0b07f03eea56722c6ef92fa345`; the exact pull request initially
> has that head and base tuple and is OPEN, non-draft, and unmerged. The
...
- [ ] Agent mode validates the repository, pull request number, and current
      full head OID, authorized base ref and exact base commit OID, and
...
- [ ] A default-host substitution cannot pass the certified exact-subject
      ...
      exact identity, authorized base ref and exact base commit OID,
      ...
      head-preserving base retarget cannot pass that initial or final subject
      comparison and must return `UNKNOWN`.
