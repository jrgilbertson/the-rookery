...
- 2026-08-27 | 4a8bcf77c3fd5057c07a5631dc1dd9e1da61f712 (working tree) | U12 exact delivery-boundary structural checks | pass (228/228) | The fixture suite proves both owned contract copies name bounded uncertain-PR reconciliation and the credentialless broker boundary, while the agent-mode rubric keeps the reporting helper separate from delivery authority. This is deterministic structural evidence; any fresh-context behavioral grading remains an outer assessment.
- 2026-08-27T12:30:16Z | fd2736430928f2ba9ed22eb3dbeb152e6435c3ce | U12 final exact-head merge-readiness fixture rerun | pass (228/228) | `bash tests/checking-merge-readiness/fixtures/run-stub-checks.sh` completed with 228 passed and 0 failed assertions before this evidence record was appended.
- 2026-08-27T13:23:29Z | ab6ade56e97356cc8feb46288c8b9c1ba8012c0e (working tree) | U12 H-prime agent-subject and delivery-identity structural checks | pass (241/241) | The production-artifact fixture covers the complete protected-path policy binding, certified host/owner/name result identity, final snapshot comparison, review-only movement, and OPEN exact delivery-tuple reconciliation. This is deterministic local evidence; the fifth finding remains outside this slice.
- 2026-08-27 | working tree | U12 agent-mode full-OID fixture correction | pass | The production stub now validates the case's full OID against this repository's object format and rejects a shortened OID in a disposable external copy, while the agent-mode result shape and report-only routing remain unchanged.
- 2026-08-28 | working tree | U12 agent-mode host and policy stability binding | pass | Agent mode now pins every provider read, including subject validation, gather, and final comparison, to the certified `GH_HOST`, uses host-qualified selectors where supported, and includes the complete protected-path policy in initial/final stability snapshots. The production case rejects default-host substitution and late policy movement unless it rebuilds or returns `UNKNOWN`.
- 2026-08-28 | working tree | U12 final-B6 agent terminal and intent guards | pass (267/267) | Agent mode now requires OPEN/non-draft/unmerged state at subject validation and final comparison, returns `UNKNOWN` on a terminal-state change, and turns every owner-dependent intent baseline into a fail-closed unverifiable-intent cap without prompting. The production fixture covers all five final-B6 guard removals with disposable falsification copies and passed 267 assertions.
- 2026-08-28 | working tree | U12 actionable finding repair-path contract | pass | Actionable in-slice findings now name exact affected and proposed repair paths, and the production agent-mode case plus disposable fixture falsification prove the consumer cannot accept an omitted-path finding.
- 2026-08-28 | working tree | U12 agent-mode authorized-base binding | pass (292/292) | The report-only subject now requires the authorized base ref and exact base commit OID at initial validation and final comparison. The production case rejects a head-preserving base retarget, while disposable copies prove that removing either comparison guard or either repo-gardener caller's supplied tuple cannot pass.
- 2026-08-28 | working tree | U12 agent-mode head-ref binding | pass (300/300) | The report-only subject now requires the authorized head repository and exact Worker branch at initial validation and final comparison. Synthetic same-OID/same-base fork and branch negatives return `UNKNOWN`; disposable copies prove that removing either boundary or either caller-provided head-ref field cannot pass.
- 2026-08-28 | working tree | U12 post-return base-tuple handoff | pass (309/309) | The report-only result now carries its validated authorized base ref and OID. The production fixture rejects disposable removal of either returned field or either repo-gardener consumer comparison, so a same-head base retarget after assessment cannot grant repair authority.
