...
- 2026-08-19 | 7d17818 (working tree) | linked-issue GraphQL fixture correction | pass (142/142) | The model-facing forge now serves linked-issue comments only through a paginated GraphQL connection, rejects `gh issue view --json comments` as a substitute, and fails an under-fetched issue-comment query.
