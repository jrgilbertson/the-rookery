...
def validate_contract_sources() -> None:
    ...
    source, name = gardener_skill, "repo-gardener skill"
    ...
    require("authorizes that executor to reply 1" in source, f"{name} omits Lead-authorized option 1")
    require("executor-owned gap" in source, f"{name} omits the whole-list rework loop")
