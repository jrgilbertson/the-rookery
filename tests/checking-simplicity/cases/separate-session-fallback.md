# Separate session preserves the independent gate

Provenance: an independent agent-native review found that the portable caller
policy had no usable fallback when native fresh-context dispatch was absent.
...
- [ ] Before implementation, re-reads the complete subject and confirms its
      content and binding are unchanged; otherwise requires another review.
- [ ] Does not install a hook or weaken independence because dispatch is absent.
