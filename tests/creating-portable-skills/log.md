...
- 2026-09-24 | 0020c63 working tree | cost-and-check-pruning item 3 revision | recorded | Restated Harness B’s condition to require its 2/3 → 3/3 gain beside unavailable cost and an unresolved cost-benefit conclusion. Prompt and other five items unchanged; saved executions regraded, no model executions rerun.
- 2026-09-24 | 0020c63 working tree | independent cost-case regrade and adjudication | recorded | Separate fresh Codex subagents graded both complete anonymous four-answer packets; a different Codex subagent adjudicator used the unchanged checklist and canonical protocol. Initial regrade failed both revised Sol answers on cross-target cost wording; adjudication found their whole-target shipment deferral leaves B’s cost-benefit unresolved. Both judgments retained; no criterion relaxation or per-answer selection. Served model identities and cross-model grader independence were not verified; no paid external calls.
- 2026-09-24 | 0020c63 working tree | cost-case final review and structure | pass | A separate fresh Codex subagent, neither author nor grader, verified frozen prompt/checklist/protocol, all eight mapped verdicts/metrics, scoped aggregates and preserved history; bounded fixture/evidence correction can ship. Official cached skills-ref validator, repository integrity and privacy checks pass. No new execution, activation or whole-package behavioral qualification.
- 2026-09-24 | 0020c63 working tree | cost-case adjudication evidence | recorded | Revised Sol says “The measured gain does not yet justify that cost across the two targets” and “it does not establish that the gain is worth the measured cost across the target set”; both also log B’s pass delta and “cost not available”. Adjudication treats these as whole-target shipment deferrals, not negative B cost-benefit conclusions. Full [initial regrade](https://github.com/jrgilbertson/the-rookery/pull/168#issuecomment-5817937390) and [whole-packet adjudication](https://github.com/jrgilbertson/the-rookery/pull/168#issuecomment-5817939376) preserve all item verdicts, quotes, rationale and limits.
- 2026-09-24 | 0020c63 working tree | updated cost-case evidence scope | pass | All four revised saved answers pass. Opus prior 1/2 → revised 2/2; Sol prior 0/2 → revised 2/2. With other cases unchanged, original-refresh totals are Opus 7/12 → 12/12 and Sol 5/12 → 12/12. Earlier cost-case grades and Sol 6/12 aggregate below are historical. Quick-adoption results are unaffected; no new final-head execution or activation claim.
- 2026-09-24 | 15abed3 | regrade: Opus 5.5: cost-and-check-pruning, prior r1 | fail (4/6); items 3, 5 | $0.1330 reported cost; 44,453 total tokens, 34 s; reused execution, no additional execution charge; item 3 revision at 0020c63 working tree, whole-packet adjudication
- 2026-09-24 | b3917a2 | regrade: Opus 5.5: cost-and-check-pruning, revised r2 | pass (6/6) | $0.1317 reported cost; 42,856 total tokens, 47 s; reused execution, no additional execution charge; item 3 revision at 0020c63 working tree, whole-packet adjudication
- 2026-09-24 | b3917a2 | regrade: Opus 5.5: cost-and-check-pruning, revised r1 | pass (6/6) | $0.1280 reported cost; 30,708 total tokens, 38 s; reused execution, no additional execution charge; item 3 revision at 0020c63 working tree, whole-packet adjudication
- 2026-09-24 | 15abed3 | regrade: Opus 5.5: cost-and-check-pruning, prior r2 | pass (6/6) | $0.1753 reported cost; 61,649 total tokens, 44 s; reused execution, no additional execution charge; item 3 revision at 0020c63 working tree, whole-packet adjudication
- 2026-09-24 | 15abed3 | regrade: Sol high: cost-and-check-pruning, prior r2 | fail (5/6); items 3 | cost not available; 113,054 total tokens, 97 s; reused execution, no additional execution charge; item 3 revision at 0020c63 working tree, whole-packet adjudication
- 2026-09-24 | b3917a2 | regrade: Sol high: cost-and-check-pruning, revised r1 | pass (6/6) | cost not available; 84,126 total tokens, 65 s; reused execution, no additional execution charge; item 3 revision at 0020c63 working tree, whole-packet adjudication
- 2026-09-24 | b3917a2 | regrade: Sol high: cost-and-check-pruning, revised r2 | pass (6/6) | cost not available; 126,626 total tokens, 77 s; reused execution, no additional execution charge; item 3 revision at 0020c63 working tree, whole-packet adjudication
- 2026-09-24 | 15abed3 | regrade: Sol high: cost-and-check-pruning, prior r1 | fail (5/6); items 3 | cost not available; 123,316 total tokens, 96 s; reused execution, no additional execution charge; item 3 revision at 0020c63 working tree, whole-packet adjudication
