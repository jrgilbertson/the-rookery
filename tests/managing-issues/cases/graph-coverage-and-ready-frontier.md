...
> the configured `needs-planning` label. `ENG-13` carries
> `ready-for-implementation`, but its Verification section is empty.
...
- [ ] Derives `ENG-11` as `ready-for-implementation` and `ENG-13` as
