...
each PR failed a repository gate a Worker could satisfy. This slice does
...
> (1) dispatch for that PR. (2) The Orchestrator authorizes an option-1
...
> collaborator and fails the same check. (5) An unrelated new-PR Worker
