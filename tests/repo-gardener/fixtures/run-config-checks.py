...
"""
        ...
        for file_mode_command in (
            ...
            ["env", "--", "MODE=setup", "PWSH.EXE", "-exec", "Bypass", "scripts/setup.ps1", "-c", "literal"],
            ...
            ["env", "--", "MODE=setup", "PWSH.EXE", "-f", "scripts/setup.ps1", "-Command"],
        ...
        malformed_setup_commands: tuple[tuple[Any, str], ...] = (
            ...
            (["env", "MODE=setup", "PWSH.EXE", "-CWA", "repo-setup"], "setup_command contains forbidden command-string wrapper"),
            ([r"C:\\Windows\\System32\\ENV.EXE", "--", "MODE=setup", "/usr/local/bin/pwsh.exe", "-cwa", "repo-setup"], "setup_command contains forbidden command-string wrapper"),
            ...
            (["env", "--", "MODE=setup", "PWSH.EXE", "-Co", "repo-setup"], "setup_command contains forbidden command-string wrapper"),
            ...
            (["env", "--", "MODE=setup", "PWSH.EXE", "--Enco", "aW52YWxpZA=="], "setup_command contains forbidden command-string wrapper"),
            ...
            (["env", "--", "MODE=setup", "PowerShell.EXE", "Write-Output invalid"], "setup_command contains forbidden command-string wrapper"),
